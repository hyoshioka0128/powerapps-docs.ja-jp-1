...
## <a name="demonstrates"></a>説明  
 このサンプルには、リボン定義をエクスポートする方法を示します。 <xref:Microsoft.Crm.Sdk.Messages.RetrieveApplicationRibbonRequest> メッセージおよび <xref:Microsoft.Crm.Sdk.Messages.RetrieveEntityRibbonRequest> メッセージを使用します。  
