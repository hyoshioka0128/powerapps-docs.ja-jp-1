...
- [このサンプルの実行](#bkmk_runsample)  
- [コード サンプル](#bkmk_codeSample)  
...
[Web API 機能およびアクションのサンプル (C#)](functions-actions-csharp.md)<br />
...
[Web API 条件付き演算のサンプル (クライアント側の JavaScript)](conditional-operations-client-side-javascript.md)
