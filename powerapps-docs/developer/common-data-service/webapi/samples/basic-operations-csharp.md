...
[Web API 基本操作のサンプル (C#)](https://github.com/Microsoft/PowerApps-Samples/tree/master/cds/webapi/C%23) に移動して、サンプル リポジトリをクローンもしくはダウンロードし、ローカル フォルダに内容を解凍してください。 このフォルダには次のファイルがあります。  
...
## <a name="code-listing"></a>コード一覧
 ...
 すべてのサンプルをダウンロードするには [ここ](https://github.com/Microsoft/PowerApps-Samples/tree/master/cds/webapi/C%23) をクリックします。
