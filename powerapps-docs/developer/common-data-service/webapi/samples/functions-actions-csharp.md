...
[Web API 機能およびアクションのサンプル (C#)](https://github.com/Microsoft/PowerApps-Samples/tree/master/cds/webapi/C%23/FunctionAndActions) に移動して、サンプル リポジトリを複製またはダウンロードし、ローカル フォルダにファイルの内容を解凍してください。 このフォルダには、次のファイルが含まれている必要があります。  
...
[Web API 機能およびアクションのサンプル](../web-api-functions-actions-sample.md)
[Web API 基本操作のサンプル (C#)](basic-operations-csharp.md)<br />
[Web API クエリ データのサンプル (C#)](query-data-csharp.md)<br />
[Web API 条件付き演算サンプル (C#)](conditional-operations-csharp.md)
