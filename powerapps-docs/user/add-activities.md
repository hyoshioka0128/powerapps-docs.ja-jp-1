...
1. 上部のナビゲーション バーで **[新規]** ![[レコードの作成] ボタン](media/create-record-button.png "レコードの作成ボタン") > **[アクティビティ]** を選択し、追加するアクティビティの種類を選びます。
...
3. **所有者**フィールドは、既定で現在のユーザーに設定されます。 タスクを再度割り当てる場合は、検索アイコンを選択してから別のユーザーまたはチームを選択します。  
