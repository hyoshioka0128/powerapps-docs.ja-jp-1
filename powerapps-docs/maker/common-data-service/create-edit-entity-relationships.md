...
レコード間のあまり正式でない関連付けは、*つながり*と呼ばれます。 たとえば、2 人の取引先担当者は結婚していること、または職場外の友人であること、またはある取引先担当者は以前別の取引先企業で働いていたことなどを把握しておくと便利場合があります。 ほとんどの企業では、このような情報を使ってレポートを作成したり、入力を要求することがないため、エンティティ関係を作成する価値がないと言えるでしょう。 詳細: [つながりロールを構成する](configure-connection-roles.md)
