...
| **Location.Latitude** |-90 から90の数値を返します。これは、赤道からの度数で測定した緯度を示します。 正数は、赤道より北の位置を示します。 |
| **Location.Longitude** |英国 (英国) からの度数で計測された、経度を示す-180 から180の数値を返します。  正の数値は、Greenwhich の東の場所を示します。 |
...
| **場所** |現在位置の緯度と経度をレコードとして返します。 |{&nbsp;Latitude:&nbsp;47.591, Longitude:&nbsp;122.333&nbsp;} |
