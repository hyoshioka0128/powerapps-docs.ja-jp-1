---
title: PowerApps ポータルのグローバル検索 | MicrosoftDocs
...
ms.locfileid: "2760642"
---
# <a name="search"></a>Search

PowerApps ポータルでは、ポータルのグローバル検索機能を使用して複数のエンティティにまたがりレコードを検索できます。 さらに、エンティティ リストの検索機能を使用してエンティティ リストのレコード内で検索できます。 
...
次のセクションでは、PowerApps ポータルでグローバル検索がどのように機能するかを詳述し、使用できる各種構成オプションを説明します。
...
PowerApps ポータルの検索インデックスの更新は、キャッシュ無効化と同様に自動的に行われます。 留意すべき重要な事柄、しかし:
