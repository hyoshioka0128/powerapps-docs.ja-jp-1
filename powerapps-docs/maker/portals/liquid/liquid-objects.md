...
|                url                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    エンティティの PowerApps ポータル コンテンツ管理システム URL パスを返します。 エンティティに現在の Web サイトで有効な URL がない場合、null が返されます。 通常これは、アプリケーションで URL プロバイダーをカスタマイズしていない限り、ポータル CMS に統合されている特定のエンティティの種類についての値のみを返します。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
